...
export class Backend implements backendInterface {
    ...
    async getTodayOrders(): Promise<Array<Order>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTodayOrders();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProductRate(arg0: bigint, arg1: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProductRate(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
